...
Per definizione un nodo viene definito potente quando è connesso a nodi che non lo sono, 
```{r, echo=TRUE,message=FALSE, warning=FALSE}
# Trasforma il tuo output in un dataframe per lavorarci meglio
df_triads <- data.frame(
  tipo = names(risultato_triadi),
  conteggio = as.numeric(risultato_triadi)
)

# Funzione rapida per classificare (semplificata)
# P = +, N = -
# Regola: numero dispari di 'N' = Sbilanciato
